  ...
  return (
    <main className="flex-1 w-full max-w-[1440px] mx-auto px-4 md:px-10 lg:px-40 py-16 flex flex-col items-center">
      <div className="w-full max-w-2xl">
        ...
        <div className="bg-white dark:bg-[#1a2c30] p-8 md:p-12 rounded-2xl shadow-sm border border-[#f0f4f4] dark:border-[#2a3c40]">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-1.5">
              <label className="text-sm font-semibold text-[#101f22] dark:text-white" htmlFor="email">
                Correo Electrónico
              </label>
              <input
                className="w-full bg-[#f6f8f8] dark:bg-[#203438] border-[#e2e8f0] dark:border-[#2a3c40] rounded-lg px-4 py-3 text-sm focus:ring-primary focus:border-primary placeholder:text-gray-400 dark:text-white transition-all"
            ...
            <div className="space-y-1.5">
              <label className="text-sm font-semibold text-[#101f22] dark:text-white" htmlFor="message">
                Mensaje
              </label>
              <textarea
            ...
            <div className="flex items-center gap-3 py-2">
              <input
                className="rounded text-primary focus:ring-primary size-4 cursor-pointer border-[#e2e8f0] dark:border-[#2a3c40]"
                id="terms"
                required
                type="checkbox"
              />
              <label className="text-xs text-[#618389] dark:text-gray-400 leading-tight" htmlFor="terms">
          ...
          <div className="mt-12 pt-8 border-t border-gray-100 dark:border-[#2a3c40]">
            <h4 className="text-xs font-black text-[#101f22] dark:text-white uppercase tracking-[0.1em] mb-6 text-center">
              Atención Directa
            </h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="flex flex-col items-center text-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-base font-bold dark:text-white">+34 971 00 00 00</p>
                </div>
              </div>
              ...
              <div className="flex flex-col items-center text-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-base font-bold dark:text-white">Palma, Mallorca</p>
                </div>
              </div>
            </div>
          </div>
