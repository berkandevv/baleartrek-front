...
import { getAttendeeCount, getAttendeeId, isCurrentUserGuide } from '../utils/trekDetailsPageUtils'
...
export default function MeetingDetailsPage() {
  ...
  const isClosed = !isMeetingActive(meeting)
  const isApplicationOpen = isApplicationOpenToday(meeting)
